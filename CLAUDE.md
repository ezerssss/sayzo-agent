...
[AEC pre-pass — WebRTC AEC3 via livekit.rtc.apm; subtracts speaker bleed from
 mic at the sample level. Off by default in v3.4.0; SAYZO_AEC__ENABLED=1 to
 turn on. v3.4.1 flips the default ON.]
    ↓
